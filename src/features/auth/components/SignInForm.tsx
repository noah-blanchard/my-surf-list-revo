...
export function SignInForm({
    ...
    const onSubmit = form.onSubmit(async ({ email, password }) => {
        ...
        setLoading(false);
        if (res?.ok === false) setError(res.message ?? "Sign in failed");
    });
    ...
    return (
        ...
        >
            <Stack gap="md">
                ...
                <Text c="dimmed" ta="center" size="sm">Enter your email and password to continue</Text>
                ...
                <Group justify="space-between" mt="md">
                    <Anchor size="sm" href={forgotHref}>Forgot password?</Anchor>
                    <Anchor size="sm" href="/sign-up">Create an account</Anchor>
                </Group>
